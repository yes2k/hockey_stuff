...
The function below takes the play-by-play data and extracts the relevant variable defined above and returns a dataframe
```{r}
...
model <- glm(home_team_win~., data=df %>% dplyr::select(-c("game_id", "num_home_players", "num_away_players")), family="binomial")
summary(model)
